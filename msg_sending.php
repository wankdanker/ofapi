...
* @version 1.1.3 (2008/09/03): Added parameters check
...
/**
* Reply to a post id in a given forum
* <br/><b>PARAMETERS:</b><br/>
* - <b>$subject</b> 			<i>[string]</i> 			specify your topic subject <br/>
* - <b>$message</b> 			<i>[string]</i> 			specify your message text <br/>
* - <b>$forum_id</b> 			<i>[integer]</i>		 	specify destination forum id <br/>
* - <b>$topic_id</b> 			<i>[integer]</i> 			specify topic id <br/>
* - <b>$post_id</b> 			<i>[boolean/optional]</i> 	specify post id <br/>
* - <b>$enable_bbcode</b> 		<i>[boolean/optional]</i> 	enable bbcodes <br/>
* - <b>$enable_smiles</b> 		<i>[boolean/optional]</i> 	enable graphical smiles encoding <br/>
* - <b>$enable_urls</b>			<i>[boolean/optional]</i> 	enable url links in post <br/>
* - <b>$enable_sign</b> 		<i>[boolean/optional]</i> 	insert logged signature (if available) at the bottom of the post <br/>
* - <b>$forumPassword</b> 		<i>[string]</i> 			forum password is the forum is protected <br/>
*
* @since 1.0
* @version 1.0
* @see THIS FUNCTION COULD REQUIRE LOGIN DEPENDING BOARD LEADERS SETTINGS
* @return integer <b>AVAILABLE ERRORS MESSAGES:</b><br/><br/>
*			-----------------------------------------
* 			- <b>NO_POST_MODE</b>					no post mode<br/>			
*			- <b>MSG_FORUM_ERR_FORUMPASSWORDED</b>	forum is password protected and you have not specified a key<br/>
*			- <b>BOT_GO_HOME</b>					bot cannot act in this way (you have a bot?)<br/>
*			- <b>USER_CANNOT_READ_FORUM</b>			user cannot read specified forum<br/>
*			- <b>USER_CANNOT_POST</b>				user cannot post to this forum<br/>
*			- <b>FORUM_LOCKED</b>					specified forum is locked<br/>
*			- <b>NOT_AUTHORISED</b>					you're not authorized<br/><br/>
*<br/>
*	<b>WHEN MESSAGE IS POSTED THIS METHOD AN ARRAY WITH THESE KEYS:</b><br/><br/>
*			- <b>'topic_id'</b> 	<i>[integer]</i> 	id of the forum where you've posted<br/>
*			- <b>'forum_id'</b> 	<i>[integer]</i> 	id of the new topic<br/>
*			- <b>'post_id'</b> 		<i>[integer]</i> 	the id of the new message
*/
...
function replyToPost($args) {
	...
	if (count($args) < 11) return GENERAL_WRONG_PARAMETERS;
	...
	$topic_id = $args[3];
	$post_id = $args[4];
	$enable_bbcode = $args[5];
	$enable_smiles = $args[6];
	$enable_urls = $args[7];
	$enabke_sign = $args[9];
	$forumPassword = $args[10];
	return ofapi_submit('reply',$subject,$message,$forum_id,$topic_id,$post_id,POST_NORMAL,true,true,true,true,$forumPassword);
}

/**
* Delete topic from a forum
* <br/><b>PARAMETERS:</b><br/>
* - <b>$forum_id</b> <i>[integer]</i> specify forum id
* - <b>$topic_id</b> <i>[integer]</i> specify topic id
*
* @since 1.0
* @version 1.0
* @see THIS FUNCTION COULD REQUIRE LOGIN DEPENDING BOARD LEADERS SETTINGS
...
function deleteTopic($args) {
	...
	$forum_id = $args[0];
	$topic_id = $args[1];
	return ofapi_submit('delete',null,null,$forum_id,$topic_id,-1,POST_DELETED,true,true,true,true,null);
}

/**
* Delete post from a forum
* <br/><b>PARAMETERS:</b><br/>
* - <b>$forum_id</b> 		<i>[integer]</i> 	specify forum id<br/>
* - <b>$topic_id</b> 		<i>[integer]</i> 	specify topic id<br/>
* - <b>$post_id</b> 		<i>[integer]</i> 	specify post id<br/>
* - <b>$forumPassword</b> 	<i>[integer]</i> 	specify password if needed<br/>
*
* @since 1.0
* @version 1.0
* @see THIS FUNCTION COULD REQUIRE LOGIN DEPENDING BOARD LEADERS SETTINGS
...
function deletePost($args) {
	// if number of parameters is lower than requested from headers this function return GENERAL_WRONG_PARAMETERS
	if (count($args) < 3) return GENERAL_WRONG_PARAMETERS; // forumPassword is not a required parameter
    
	$forum_id = $args[0];
	$topic_id = $args[1];
	$post_id = $args[2];
	$forumPassword = $args[3];
	return ofapi_submit('delete',null,null,$forum_id,$topic_id,$post_id,POST_DELETED,true,true,true,true,$forumPassword);	
}

/**
* This function is used to post a new topic to a given forum
* <br/><b>PARAMETERS:</b><br/>
* - <b>$subject</b> 				<i>[string]</i> 			specify your topic subject<br/>
* - <b>$message</b> 				<i>[string]</i> 			specify your message text<br/>
* - <b>$forum_id</b> 				<i>[integer]</i> 			specify destination forum id<br/>
* - <b>$type</b> 					<i>[integer]</i> 			POST_NORMAL or POST_STICKY<br/>
* - <b>$enableBBCode</b> 			<i>[boolean/optional]</i> 	enable bbcode symbols<br/>
* - <b>$enable_smiles</b> 			<i>[boolean/optional]</i> 	enable graphical smiles encoding<br/>
* - <b>$enable_urls</b> 			<i>[boolean/optional]</i> 	enable url links in post<br/>
* - <b>$enable_sign</b> 			<i>[boolean/optional]</i> 	insert logged signature (if available) at the bottom of the post<br/>
* - <b>$forumPassword</b> 			<i>[string]</i> 			specify password string<br/>
*
* @since 1.0
* @version 1.0
* @see THIS FUNCTION COULD REQUIRE LOGIN DEPENDING BOARD LEADERS SETTINGS
* @return <b>AVAILABLE ERRORS MESSAGES:</b><br/><br/>
* 				- <b>NO_POST_MODE</b>					no post mode<br/>			
*				- <b>MSG_FORUM_ERR_FORUMPASSWORDED</b>	forum is password protected and you have not specified a key<br/>
*				- <b>BOT_GO_HOME</b>					bot cannot act in this way (you have a bot?)<br/>
*				- <b>USER_CANNOT_READ_FORUM</b>			user cannot read specified forum<br/>
...
function postNewTopic($args) {
	...
	$message = $args[1];
	$forum_id = $args[2];
	$enableBBCode = $args[3]; if (!isset($args[3])) $enableBBCode = true;
	$enable_smiles = $args[4]; if (!isset($args[4])) $enable_smiles = true;
	$enable_urls = $args[5]; if (!isset($args[5])) $enable_urls = true;
	$enable_sign = $args[6]; if (!isset($args[6])) $enable_sign = true;
	$forumPassword = $args[7];
	
	return _postNewMessage($subject,$message,$forum_id,POST_NORMAL,$enableBBCode,$enable_smiles,$enable_urls,$enable_sign,$forumPassword);
}

/**
* This function return both subject and text of choosed post id
* <br/><b>PARAMETERS:</b><br/>
* - <b>$forum_id</b> 		<i>[integer]</i> 	specify destination forum id<br/>
* - <b>$topic_id</b> 		<i>[integer]</i> 	specify topic id<br/>
* - <b>$post_id</b> 		<i>[integer]</i> 	specify post id<br/>
...
*
*	<b>WHEN MESSAGE IS POSTED THIS METHOD AN ARRAY WITH THESE KEYS:</b><br/><br/>
*			- <b>'post_subject'</b> 	<i>[integer]</i> 	subject of the message<br/>
*			- <b>'post_text'</b> 		<i>[integer]</i> 	text of the message<br/>
*/

function getPostText($forum_id,$topic_id,$post_id,$forumPassword) {
	// if number of parameters is lower than requested from headers this function return GENERAL_WRONG_PARAMETERS
	if (count($args) < 3) return GENERAL_WRONG_PARAMETERS;
	...
	$post_id = $args[2];
	$forumPassword = $args[3];
	return ofapi_submit('edit_get','','',$forum_id,$topic_id,$post_id,true,true,true,true,$forumPassword);
}


/**
* This function allows you to edit a posted message (if you have enough rights to do it)
* <br/><b>PARAMETERS:</b><br/>
* - <b>$new_subject</b> 		<i>[integer]</i> 	specify new subject<br/>
* - <b>$new_message</b> 		<i>[integer]</i> 	specify new message text<br/>
* - <b>$forum_id</b> 			<i>[integer]</i> 	specify forum id<br/>
* - <b>$topic_id</b> 			<i>[integer]</i> 	specify topic id<br/>
* - <b>$post_id</b> 			<i>[integer]</i> 	specify post id<br/>
* - <b>$forumPassword</B>		<i>[string]</i>		specify forum password if needed
*
* @since 1.0
* @version 1.0
* @see THIS FUNCTION COULD REQUIRE LOGIN DEPENDING BOARD LEADERS SETTINGS
...
function editPostWithData($args) {
	// if number of parameters is lower than requested from headers this function return GENERAL_WRONG_PARAMETERS
	if (count($args) < 5) return GENERAL_WRONG_PARAMETERS;
	...
	$topic_id = $args[3];
	$post_id = $args[4];
	$forumPassword = $args[5];
	return ofapi_submit('edit_post',$new_subject,$new_message,$forum_id,$topic_id,$post_id,$topic_type,true,true,true,true,$forumPassword);
}

/*
 * @ignore
*/
function _postNewMessage($subject,$message,$forum_id,$typeOfPost = POST_NORMAL,$enableBBCode = true ,$enable_smiles = true ,$enable_urls = true ,$enable_sign = true, $forumPassword) {
	return ofapi_submit('post',$subject,$message,$forum_id,$typeOfPost,$enableBBCode,$enable_smiles,$enable_urls,$enable_sign,$forumPassword);
}
 ...
 *
 * $mode = 'post' || 'edit_get' || 'edit_post' || 'reply'
 * 
 * $mode = 'post'
 * ------------------------
 * 		$subject = soggetto
 * 		$message = messaggio
 * 		$forum_id   = id del forum dove scrivere
 * 		$topic_type = POST_NORMAL || POST_STICKY || POST_GLOBAL
 *		$enable_bbcode  = true,
 *		$enable_smilies = true, 
 *		$enable_urls    = true, 
 *		$enable_sig     = true
 *
 * RITORNA: un codice di errore tra quelli sopra
 * oppure il topic_id e msg_id del nuovo argomento.
 * 
 * 
 * $mode = 'quote'
 * ------------------------
 ...
 * 		$topic_id   = id topic 
 *		$post_id    = id messaggio da quotare
 *		$enable_bbcode  = true,
 *		$enable_smilies = true, 
 *		$enable_urls    = true, 
 *		$enable_sig     = true
 ...
 * 
 * RITORNA: un codice di errore tra quelli sopra
 * oppure il topic_id del nuovo argomento.
 * 
 * 
 * $mode = 'delete'
 * ------------------------
 ...
 *		$post_id    = id messaggio 
 *		
 * RITORNA: un codice tra quelli sopra
 * 
 * 
 */

function ofapi_submit(	$mode, 
	...
	global $user, $auth, $config, $db;
	
// Start session management
//$user->session_begin();
$auth->acl($user->data);

$submit  = ($mode == 'post' || $mode == 'reply' || $mode == 'quote');
...
{
	return PROTECTED_FORUM_NEED_PASSWORD;
...
if ($post_data['forum_password']) {
    if (!isset($password)) return MSG_FORUM_ERR_FORUMPASSWORDED; // forum is passworded, you have not given it
        ...
        $returnLogin = loginProtectedForumWithPassword($forum_id,$forumPassword);
        switch ($returnLogin) {
            case LOGIN_FPSWD_OK:
		return ofapi_submit($mode,$subject,$forum_id,$topic_id,$post_id,$topic_type,$enable_bbcode,$enable_smilies,$enable_urls,$enable_sig,$forumPassword);
                break;
...
switch ($mode)
{
	...
	case 'delete':
		...
		{
			$is_authed = true;
		} else return USER_CANNOT_DELETE;
	break;
}
...
if (($post_data['forum_status'] == ITEM_LOCKED || (isset($post_data['topic_status']) && $post_data['topic_status'] == ITEM_LOCKED)) && !$auth->acl_get('m_edit', $forum_id))
{
	...
	return ($post_data['forum_status'] == ITEM_LOCKED) ? FORUM_LOCKED : TOPIC_LOCKED;
}
...
if ($mode == 'edit' && !$auth->acl_get('m_edit', $forum_id))
{
	if ($user->data['user_id'] != $post_data['poster_id'])
	{
		...
		return USER_CANNOT_EDIT;
	}

	if (!($post_data['post_time'] > time() - ($config['edit_time'] * 60) || !$config['edit_time']))
	{
		//trigger_error('CANNOT_EDIT_TIME');
		return CANNOT_EDIT_TIME;
	}

	if ($post_data['post_edit_locked'])
	{
		//trigger_error('CANNOT_EDIT_POST_LOCKED');
		return CANNOT_EDIT_POST_LOCKED;
	}
}
...
{
	// controllare... ok
	return handle_post_delete($forum_id, $topic_id, $post_id, $post_data);
	//exit_handler();
}
...
if ($mode != 'edit')
{
	...
	$post_data['enable_urls']		= $enable_urls;// true;
}
...
{
	$post_data['topic_cur_post_id']	= 0; //request_var('topic_cur_post_id', 0);
	$post_data['post_subject']		= utf8_normalize_nfc($subject);
	$message_parser->message		= utf8_normalize_nfc($message);

	$post_data['username']			= utf8_normalize_nfc($post_data['username']); //utf8_normalize_nfc(request_var('username', $post_data['username'], true));
	...
	$post_data['topic_type']		= (($mode != 'post') ? (int) $post_data['topic_type'] : $topic_type); //request_var('topic_type', (($mode != 'post') ? (int) $post_data['topic_type'] : POST_NORMAL));
	$post_data['topic_time_limit']	= (($mode != 'post') ? (int) $post_data['topic_time_limit'] : 0); //request_var('topic_time_limit', (($mode != 'post') ? (int) $post_data['topic_time_limit'] : 0));
	$post_data['icon_id']			= 0; //request_var('icon', 0);

	$post_data['enable_bbcode']		= (!$bbcode_status || !$enable_bbcode) ? false : true; //(!$bbcode_status || isset($_POST['disable_bbcode'])) ? false : true;
	$post_data['enable_smilies']	= (!$smilies_status || !$enable_smilies) ? false : true; //(!$smilies_status || isset($_POST['disable_smilies'])) ? false : true;
	$post_data['enable_urls']		= ($enable_urls ? 1 : 0); //(isset($_POST['disable_magic_url'])) ? 0 : 1;
	$post_data['enable_sig']		= $enable_sig ? true : false; //($config['allow_sig'] ? true : false); //(!$config['allow_sig'] || !$auth->acl_get('f_sigs', $forum_id) || !$auth->acl_get('u_sig')) ? false : ((isset($_POST['attach_sig']) && $user->data['is_registered']) ? true : false); (!$config['allow_sig'] || !$auth->acl_get('f_sigs', $forum_id) || !$auth->acl_get('u_sig')) ? false : ((isset($_POST['attach_sig']) && $user->data['is_registered']) ? true : false);
	...
	$topic_lock			= false; //(isset($_POST['lock_topic'])) ? true : false;
	$post_lock			= false; //(isset($_POST['lock_post'])) ? true : false;
	$poll_delete		= false; //(isset($_POST['poll_delete'])) ? true : false;
	...
	if ($post_data['topic_type'] != POST_NORMAL && ($mode == 'post' || ($mode == 'edit' && $post_data['topic_first_post_id'] == $post_id)))
	{
		...
		if (!$auth->acl_get($auth_option, $forum_id))
		{
			...
			{
				if ($auth_option == 'f_announce')
					return CANNOT_POST_ANNOUNCE;
				
				if ($auth_option == 'f_sticky')
					return CANNOT_POST_STICKY;
	...
	if (!sizeof($error) && $submit)
	{
		...
		if ($post_data['topic_type'] != POST_GLOBAL)
		{
			...
			{
				$to_forum_id = 0; //;request_var('to_forum_id', 0);
		...
		if ($submit)
		{
			...
			{
				$post_data['post_subject'] = strlen($post_data['post_subject']) == 0 ? censor_text($post_data['topic_last_post_subject']) : censor_text($post_data['post_subject']);// ((strpos($post_data['post_subject'], 'Re: ') !== 0) ? 'Re: ' : '') . censor_text($post_data['post_subject']);
			}
			...
			//FATTO! Possiamo uscire!
			// Decidere cosa far ritornare all'indietro all'utente,
			// se un codice di conferma o altro.
			// per il momento restituisco il topic_id
			return array(
...
// ritorna i parametri per la modifica
// decidere cosa restituire
// -------------------------------------
return array('post_subject'	=> $post_data['post_subject'],
